(function() {
  ...
  _.some = function(collection, iterator) {
    ...
    _.every(collection, function(item) {
      someTrue = Boolean(iterator(item) || someTrue);
    });
    return someTrue;
  };
  ...
  _.extend = function(obj) {
    var numSources = arguments.length - 1;
  ...
  _.delay = function(func, wait) {
    ...
    for (var i = 2; i < arguments.length; i++) {
      newArgsArr.push(arguments[i]);
    }

    setTimeout(function() {
      func.apply(this, newArgsArr);
    }, wait);
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      while (!numberPlaced) {
        ...
        if (newArray[position] === undefined) {
